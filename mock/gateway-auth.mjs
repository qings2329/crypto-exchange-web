...
export const users = [
  { id: 1, username: "admin", email: "admin@ce.dev", phone: "13800000001", password: "qwert@123x", role: "admin", nickname: "管理员", kyc_level: 2, tfa_enabled: true, email_verified: true, phone_verified: true, status: 0 },
  { id: 2, username: "op", email: "op@ce.dev", phone: "13800000002", password: "qwert@123x", role: "operator", nickname: "运营", kyc_level: 1, tfa_enabled: false, email_verified: true, phone_verified: false, status: 0 },
  { id: 3, username: "user1", email: "user@ce.dev", phone: "13800000003", password: "qwert@123x", role: "user", nickname: "普通用户", kyc_level: 0, tfa_enabled: false, email_verified: true, phone_verified: false, status: 0 },
];
